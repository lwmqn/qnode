...
function MqttNode(clientId, lifetime, version, ip) {
...
MqttNode.Generate = require('template');
...
/*** MqttNode Prototype                                                                        ***/
/*************************************************************************************************/
MqttNode.prototype.registerSmartObject = function (so) {
...
MqttNode.prototype._connectedHandler = function (mc) {
    var self = this,
