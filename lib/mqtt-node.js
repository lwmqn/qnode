...
MqttNode.prototype._pubReq = function (intf, data, callback) {
    var self = this;
    data.transId = this.nextTransId();  // [TODO] n:_id(intf)

    if (_.isFunction(callback)) {
        var key = intf + ':rsp:' + data.transId;
        this._tmout(key, reqTimeout);
...
MqttNode.prototype.pubResponse = function (rsp, callback) {
    var rspPubChannel = this._pubics.response;
    this.publish(rspPubChannel, rsp, callback);
    return this;
};
