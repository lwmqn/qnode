...
/*** Public Methods                                                                            ***/
/*************************************************************************************************/
MqttNode.prototype.setDevAttrs = function (devAttrs) {
    // clientId and mac changes at runtime are ignored
    this.lifetime = Math.floor(devAttrs.lifetime) || this.lifetime;
    this.ip = devAttrs.ip || this.ip;
    this.version = devAttrs.version || this.version;
};
